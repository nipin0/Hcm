...
# Cooldown config keys and their defaults (stored in hcm_config.metadata)
COOLDOWN_CONFIG_DEFAULTS: dict[str, Any] = {
    "pretrend_cooldown_seconds": 180,
    "trend_cooldown_seconds": 120,
    "trend_same_dir_bypass_score": 0.60,
    "trend_same_dir_mid_cooldown": 60,
    "trend_reverse_cooldown_seconds": 300,
    "fade_cooldown_seconds": 300,
    "range_boundary_cooldown_seconds": 0,
    "neutral_cooldown_seconds": 300,
    # ── Scoring engine thresholds (added 2026-07-11) ──
    "pretrend_threshold": 70,
    "trend_threshold": 70,
    "fade_threshold": 30,
...
# Prompt config keys and their defaults (stored under signal_tower.prompt.*)
PROMPT_CONFIG_FIELDS: dict[str, Any] = {
    "system_prompt": "",
    "regime_prompt_template": "",
...
def create_signal_tower_router(
    ...
    async def legacy_get_threshold(
        ...
        """[Legacy] Get cooldown/threshold config — alias for /api/v1/signal-tower/cooldown."""
        return await _get_cooldown_impl(symbol)
